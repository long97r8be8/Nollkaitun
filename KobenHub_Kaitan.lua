...
_G.AutoFullySuperhuman = true
	...
	game.StarterGui:SetCore("SendNotification", {
		Title = "LongHuy x Hub Notification", 
		Text = "Loading Script...",
		Icon = "http://www.roblox.com/asset/?id=18871428100",
		Duration = 1
	})
	wait(0.3)
	game.StarterGui:SetCore("SendNotification", {
...
wait(0.2)
	game.StarterGui:SetCore("SendNotification", {
		Title = "LongHuy x Hub Notification", 
		Text = "Wellcome to LongHuy x Hub Premium Script",
		Icon = "http://www.roblox.com/asset/?id=18871428100",
		Duration = 2
	})
	wait(0.1)
...
local library = {
	WorkspaceName = "LongHuy X HUB KAITAN SERISE X",
	flags = {},
	signals = {},
	objects = {},
	elements = {},
...
local PepsiUi = library:CreateWindow({
    Name = "LongHuy x Hub Utimate Kaitan Script",
    Theme = {
        Image = "rbxassetid://18871428100",
        Info = "LongHuy X HUB PAID SCRIPT",
        Background = {
            Asset = "rbxassetid://18871428100"
        }
    }
})
...
Time:AddLabel({
    Name = "[ LongHuy X HUB Paid Script ]"
})
